...
class EventEmulator(object):
    ...
    def generate_events(self, new_frame, t_frame):
        ...
        # self.update_mask = (final_neg_evts_frame+final_neg_evts_frame) != 0
        # self.base_log_frame[self.update_mask] = self.lp_log_frame[self.update_mask]
        ...
        del final_pos_evts_frame
        del final_neg_evts_frame
        del shot_noise_events

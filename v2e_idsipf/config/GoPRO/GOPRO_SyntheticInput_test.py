...
class GOPRO_SyntheticInput_test(base_synthetic_input): # the class name should be the same as the filename, like in Java
    ...
    def __init__(self, *args, **kwargs) -> None:
        ...
        self.log = sys.stdout
        self.key = kwargs['key']
        self.dict_path = source_path.test.source_path_dict
        ...
        self.file_path = ''
        # parse saving path
        self.event_path = os.path.join(source_path.test.target.events_path, self.key)
        self.event_vis_path = os.path.join(source_path.test.target.events_vis_path, self.key)
        self.accint_path = os.path.join(source_path.test.target.accint_path, self.key)
        self.event_vis_acc_path = os.path.join(source_path.test.target.event_vis_acc_path, self.key)

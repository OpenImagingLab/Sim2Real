...
def process_task(folder_name, formatted_time):
    ...
    try:
        ...
        os.system(f'python v2e_simpler.py '
                  ...
                  f'--output_width=1280 '
                  f'--output_height=720 '
                  f'--synthetic_input=config.GoPRO.GOPRO_SyntheticInput_test '
...
# Function to initialize and start worker processes
...
if __name__ == "__main__":
    # num_workers = 22
    keys = sorted(os.listdir(source_path.test.source_path))
    total = len(keys)
